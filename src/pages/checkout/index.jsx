...
export default function Checkout() {
    return (
        <>
            <Navbar />
            <div className="flex flex-col items-center border-b bg-green py-4 sm:flex-row sm:px-10 lg:px-20 xl:px-32">
  <a href="#" className="text-2xl font-bold text-gray-800">Alpha E-commence</a>
...
<div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
    ...
    <form class="mt-5 grid gap-6">
      <div class="relative">
        ...
        <label class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_1">
          <img class="w-14 object-contain" src={fedex} alt="" />
          <div class="ml-5">
      ...
      <div class="relative">
        ...
        <label class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_2">
          <img class="w-14 object-contain" src={uber} alt="" />
          <div class="ml-5">
            <span class="mt-2 font-semibold">Uber Delivery</span>
            <p class="text-slate-500 text-sm leading-6">Delivery: 2-4 Days</p>
          </div>
        </label>
      </div>
  ...
  <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
    ...
    <div class="">
      ...
      <div class="flex flex-col sm:flex-row">
        <div class="relative flex-shrink-0 sm:w-7/12">
          ...
          <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
            <img class="h-4 w-4 object-contain" src={ghana} alt="" />
          </div>
        </div>
    ...
    <button class="mt-4 mb-8 w-full rounded-md bg-blue-900 px-6 py-3 font-medium text-white">Place Order</button>
  </div>
</div>
